...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Tim_Xu"
    user-mail-address "timtsui@outlook.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/tingxu/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/tingxu/bin" "/profile/bin" "/Users/tingxu/.npm-packages/bin" "/Users/tingxu/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
