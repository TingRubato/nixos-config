...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/timmy/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/timmy/bin" "/profile/bin" "/Users/timmy/.npm-packages/bin" "/Users/timmy/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
